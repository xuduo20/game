...
//T
function T() {
	Shape.call(this, [new Cell(0, 3), //0
	new Cell(0, 4), //1
	new Cell(0, 5), //2
	new Cell(1, 4) //3
	], this.IMGS.T, 1, //参照格下标
...
//O
function O() {
	Shape.call(this, [new Cell(0, 4), new Cell(0, 5), new Cell(1, 4), new Cell(1, 5)], this.IMGS.O, 0, [new State(0, 0, 0, +1, +1, 0, +1, +1)]);
}
Object.setPrototypeOf(O.prototype, Shape.prototype);
//I
function I() {
	Shape.call(this, [new Cell(0, 3), new Cell(0, 4), new Cell(0, 5), new Cell(0, 6)], this.IMGS.I, 1, [new State(0, -1, 0, 0, 0, +1, 0, +2), new State(-1, 0, 0, 0, +1, 0, +2, 0)]);
}
Object.setPrototypeOf(I.prototype, Shape.prototype);
//S 04,05,13,14 orgi 3 states2
function S() {
	Shape.call(this, [new Cell(0, 4), new Cell(0, 5), new Cell(1, 3), new Cell(1, 4)], this.IMGS.S, 2, [new State(-1, 0, -1, +1, 0, 0, 0, -1), new State(-1, -1, 0, -1, 0, 0, +1, 0)]);
}
Object.setPrototypeOf(S.prototype, Shape.prototype);
//Z 03,04,14,15 orgi 2 states 2
function Z() {
	Shape.call(this, [new Cell(0, 3), new Cell(0, 4), new Cell(1, 4), new Cell(1, 5)], this.IMGS.Z, 2, [new State(-1, -1, -1, 0, 0, 0, 0, +1), new State(-1, -1, 0, -1, 0, 0, +1, 0)]);
}
Object.setPrototypeOf(Z.prototype, Shape.prototype);
//L 03,04,05,13 orgi 1 states4
function L() {
	Shape.call(this, [new Cell(0, 3), new Cell(0, 4), new Cell(0, 5), new Cell(1, 3)], this.IMGS.L, 1, [new State(0, -1, 0, 0, 0, +1, +1, -1), new State(-1, 0, 0, 0, +1, 0, -1, -1), new State(0, +1, 0, 0, 0, -1, -1, +1), new State(+1, 0, 0, 0, -1, 0, +1, +1)]);
}
Object.setPrototypeOf(L.prototype, Shape.prototype);
//J 03,04,05,15 orgi 1 states 4
function J() {
	Shape.call(this, [new Cell(0, 3), new Cell(0, 4), new Cell(0, 5), new Cell(1, 5)], this.IMGS.J, 1, [new State(0, -1, 0, 0, 0, +1, +1, +1), new State(-1, 0, 0, 0, +1, 0, +1, -1), new State(0, +1, 0, 0, 0, -1, -1, -1), new State(+1, 0, 0, 0, -1, 0, -1, +1)]);
}
